...
Column| Description date| Trading date open| Opening stock price high| Highest stock price low| Lowest stock price close| Closing stock price adj_close| Adjusted closing price volume| Number of shares traded
...
0 2015-05-21 00:00:00-04:00 2.800 2.874 2.411 2.568 2.568 123039000 1 2015-05-22 00:00:00-04:00 2.607 3.110 2.600 2.831 2.831 28412000 2 2015-05-26 00:00:00-04:00 2.980 3.034 2.908 2.965 2.965 8202000 3 2015-05-27 00:00:00-04:00 3.067 3.081 2.700 2.750 2.750 7976000 4 2015-05-28 00:00:00-04:00 2.755 2.774 2.648 2.745 2.745 4000000
...
<class 'pandas.core.frame.DataFrame'> RangeIndex: 2469 entries, 0 to 2468 Data columns (total 7 columns):

date 2469 non-null object open 2469 non-null float64 high 2469 non-null float64 low 2469 non-null float64 close 2469 non-null float64 adj_close 2469 non-null float64 volume 2469 non-null int64
...
date 0 open 0 high 0 low 0 close 0 adj_close 0 volume 0 dtype: int64
...
count 2469.000000 2469.000000 2469.000000 2469.000000 2469.000000 mean 48.464345 49.505495 47.347795 48.456613 48.456613 std 43.633916 44.470235 42.642546 43.573362 43.573362 min 1.939000 1.985000 1.848000 1.933000 1.933000 25% 10.479000 10.635000 10.275000 10.450000 10.450000 50% 35.640999 36.879002 34.655998 35.874001 35.874001 75% 76.080002 77.169998 74.589996 75.800003 75.800003 max 171.800003 176.291794 168.509506 169.059998 169.059998
...
print("Return Standard Deviation:", df["Daily_Return_%"].std())
...
plt.figure(figsize=(12,5)) plt.plot(df.index, df["volume"]) plt.title("Shopify Trading Volume Trend") plt.xlabel("Date") plt.ylabel("Volume") plt.xticks(rotation=45) plt.show()

Output

Trading Volume Trend Graph

Insert the screenshot of the graph generated by the notebook here.

[Insert Trading Volume Trend graph screenshot here]
...
plt.figure(figsize=(12,5)) plt.hist(df["Daily_Return_%"], bins=30) plt.title("Shopify Daily Return Distribution") plt.xlabel("Daily Return (%)") plt.ylabel("Frequency") plt.show()

Output

Daily Return Distribution Histogram

Insert the screenshot of the histogram generated by the notebook here.

[Insert Daily Return Distribution graph screenshot here]

Description

The histogram shows the distribution of daily stock returns.

Shopify Stock Price Trend
Code

plt.figure(figsize=(12, 5)) plt.plot(df.index, df["Price_Range"]) plt.title("Shopify Stock Price Trend") plt.xlabel("date") plt.ylabel("Price_Range") plt.xticks(rotation=45) plt.show()
...
[Insert Stock Price Trend graph screenshot here]
...
Project File
EDA_TASK_3(2).ipynb SHOP.csv README.md

Author

Name: Your Name Course: Your Course Task: Exploratory Data Analysis (EDA)
...
1
 (1)
@muthuarumugam81621-web
muthuarumugam81621-webMuthu Arumugam
Languages
Jupyter Notebook
100%
Footer
© 2026 GitHub, Inc.# eda5now
